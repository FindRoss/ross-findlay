    ...
    <Content>
      <div className="bg-white border rounded">
        ...
        <div className="mt-2 flex justify-center">
          {url ? (
            <a href={url.current} target="_blank" rel="noreferrer" className={buttonClass}>Website <FontAwesomeIcon icon={faArrowUpRightFromSquare} /></a>
          ) : ""}
          {github ? (
            <a href={github.current} target="_blank" rel="noreferrer" className={buttonClass}>Github <FontAwesomeIcon icon={faArrowUpRightFromSquare} /></a>
          ) : ""}
        </div>
      </div>
    </Content>
